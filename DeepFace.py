...
def stream(db_path = '', model_name ='VGG-Face', detector_backend = 'opencv', distance_metric = 'cosine', enable_face_analysis = True,enable_face_recognition=False, source = 0, time_threshold = 5, frame_threshold = 5,call_back_func=None):
	...
	realtime.analysis(db_path, model_name, detector_backend, distance_metric, enable_face_analysis
						, source = source, time_threshold = time_threshold, frame_threshold = frame_threshold,enable_face_detection=False, call_back_func=call_back_func)
